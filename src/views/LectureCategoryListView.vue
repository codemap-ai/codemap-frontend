<template>
  ...
  <div v-if="!isLoading" style="display: flex; flex-direction: column; justify-content: center; align-items: center; margin-top: 2rem;">
    <div v-for="{categoryId, title, description} of categoryList"
      ...
      <a style="position: absolute; bottom: 1.5rem; right: 1.5rem; display: flex; align-items: center; align-content: center; align-self: center; font-size: .9rem; color: #3476f6; text-decoration: inherit;"
